...
class coin(object):
    ...
    def get_minute_bar(self):
        return pyupbit.get_ohlcv(self.coin, "minute1")
...
class RSI(object):
    ...
    def __init__(self,a):
        ...
        df = pyupbit.get_ohlcv(a, "minute1")
...
while True:
    ...
    try:
        ...
        df = pyupbit.get_ohlcv(btc, "minute1")
        ...
        if before_rsi < tt and before_rsi < now_rsi and c.get_balance() == 0:
            ...
            if c.get_balance_krw() > 0:
                ...
                # 매수 한 다음 5분봉 기준 시간
                after_time = c.get_minute_bar().iloc[[199]].index[0] + datetime.timedelta(minutes=1)
